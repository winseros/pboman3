...
namespace pboman3 {
    ...
    void Registry::registerServerImpl(const wstring& pathToExe, const wstring& pathToDll) {
        ...
        setRegistryKeyValue("Software\\Classes\\CLSID\\" PBOM_SHELL_CLSID "\\InprocServer32",
                            L"Apartment",
                            L"ThreadingModel");
        setRegistryKeyValue(L"Software\\Classes\\Directory\\ShellEx\\ContextMenuHandlers\\pboman3",
                            PBOM_SHELL_CLSID);
    }

    void Registry::unregisterServerImpl() {
        removeRegistryKey(L"Software\\Classes\\Directory\\ShellEx\\ContextMenuHandlers\\pboman3");
