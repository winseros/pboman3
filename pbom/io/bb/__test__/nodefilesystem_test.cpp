...
namespace pboman3::test {
    TEST(NodeFileSystemTest, AllocatePath_Creates_Path_For_Node) {
        ...
        const QString expected = dir.path() + "/e1/e2/e3.txt";
    ...
    TEST(NodeFileSystemTest, AllocatePath_Relative_Creates_Path_For_Node) {
        const QTemporaryDir dir;
        const NodeFileSystem fs(QDir(dir.path()));
    ...
    TEST(NodeFileSystemTest, ComposeAbsolutePath_Returns_Path) {
        const QTemporaryDir dir;
        const NodeFileSystem fs(QDir(dir.path()));
        ...
        const QString expected = dir.path() + QDir::separator() + "e1" + QDir::separator() + "e2" + QDir::separator() +
            "e3.txt";
    ...
    TEST(NodeFileSystemTest, ComposeRelativePath_Returns_Path) {
        const QTemporaryDir dir;
        const NodeFileSystem fs(QDir(dir.path()));
        ...
        const QString expected = QString("e1") + QDir::separator() + "e2" + QDir::separator() + "e3.txt";
